  ...
  return (
    <>
      <article className="entry-journal">
        <img src="/dolomites.png" alt="dolomites image" />
        <div>
          <div className="upper">
            <i class="fa-solid fa-location-dot" />
            <span>ITALY</span>
            <a href="https://maps.app.goo.gl/8pMFsDtNYXqVyodX7">
              View on Google Maps
            </a>
          </div>
          <div className="lower">
            <h1>Dolomites</h1>
            <span>11 Dec, 2025 - 18 Dec, 2025</span>
            <p>
              The Dolomites in Italy are famous for their breathtaking mountain
      ...
      <article className="entry-journal">
        <img src="/lake-pukaki.png" alt="lake-pukaki image" />
        <div>
          <div className="upper">
            <i class="fa-solid fa-location-dot" />
            <span>NEW ZEALAND</span>
            <a href="https://maps.app.goo.gl/Apgd8UYTPFC4Mzkq5">
              View on Google Maps
            </a>
          </div>
          <div className="lower">
            <h1>Lake Pukaki</h1>
            <span>12 Feb, 2026 - 24 Feb, 2026</span>
            <p>
              Lake Pukaki is a large, stunning alpine lake in New Zealand's
      ...
      <article className="entry-journal">
        <img src="/dunluce-castle.png" alt="dunluce-castle image" />
        <div>
          <div className="upper">
            <i class="fa-solid fa-location-dot" />
            <span>IRELAND</span>
            <a href="https://maps.app.goo.gl/5wFet3bEZuvKYkcC9">
              View on Google Maps
            </a>
          </div>
          <div className="lower">
            <h1>Dunluce Castle</h1>
            <span>27 Apr, 2026 - 8 May, 2026</span>
            <p>
              Dunluce Castle is a ruined medieval castle in Northern Ireland,
